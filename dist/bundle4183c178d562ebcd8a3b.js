...
var buttonClicker = function buttonClicker(target) {
  ...
  var newProject = document.querySelector('#project').value;
  var modal = document.getElementById("myModal");
  var projectTabs = document.querySelectorAll('tabs'); // checks if form is empty before running functions to modify DOM
  ...
  if (target.classList == 'form-bttn') {
    ...
    addProjectTab(); //modifies animations of modal
