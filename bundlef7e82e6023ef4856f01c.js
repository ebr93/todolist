...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/****** Elad Shechter's RESET *******/\n/*** box sizing border-box for all elements ***/\n\n*,\n*::before,\n*::after{box-sizing:border-box;}\na{text-decoration:none; color:inherit; cursor:pointer;}\nbutton{background-color:transparent; color:inherit; border-width:0; padding:0; cursor:pointer;}\nfigure{margin:0;}\ninput::-moz-focus-inner {border:0; padding:0; margin:0;}\nul, ol, dd{margin:0; padding:0; list-style:none;}\nh1, h2, h3, h4, h5, h6{margin:0; font-size:inherit; font-weight:inherit;}\np{margin:0;}\ncite {font-style:normal;}\nfieldset{border-width:0; padding:0; margin:0;}\n\n/** Style **/\nhtml { \n    font-size: calc(0.625rem + 0.4vw);\n}\n \nbody {\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;\n    font-weight: 400;\n    line-height: 1.3;\n    color: white;\n}\n\n:root {\n    --main-color: #ccd0f6;\n    --button-color: #f593b7;\n    --lilac-color: #ad7ffa;\n    --blue-color: #91b2fd;\n    --background-color: #f9fafd;\n\n    --large-spacing: 20px;\n    --medium-spacing: 10px;\n    --small-spacing: 5px;\n}\n\nbutton {\n  font-weight: bolder;\n  text-align: center;\n  transition: all 0.5s;\n  display: inline-block;\n  position: relative;\n  transition: 0.5s;\n}\n\nbutton:after {\n  content: '»';\n  position: absolute;\n  opacity: 0;  \n  right: -20px;\n  transition: 0.5s;\n}\n\nbutton:hover{\n  padding-right: 24px;\n  padding-left:8px;\n}\n\nbutton:hover:after {\n  opacity: 1;\n  right: 10px;\n}\n\nimg {\n    max-width: 100%;\n}\n\n.wrapper {\n  display: grid;\n  grid-template-rows: 80px minmax(calc(100vh - 130px), 1fr) 50px;\n  grid-template-areas: \n  \"header\"\n  \"main-content\"\n  \"footer\";\n  width: 100vw;\n  background-image: linear-gradient(to right, #e65050, var(--lilac-color) , var(--blue-color));\n}\n\n.header {\n  grid-area: header;\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n}\n\n.logo {\n  font-weight: bolder;\n}\n\n.main-content {\n  grid-area: main-content;\n  display: flex;\n  padding: 0px var(--medium-spacing) 0px var(--medium-spacing);\n}\n\n/* left side of main content */\n.form-container {\n  \n}\n\n.form {\n  height: 500px;\n  width: 300px;\n  font-size: calc(1.425rem + 0.1vw);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  color: var(--button-color);\n  background-color: var(--background-color);\n  border-radius: 15px;\n  text-align: center;\n  box-shadow: 0 10px 20px -8px rgba(0, 0, 0,.7);\n  padding: 15px;\n}\n\n.checkbox-container {\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  font-size: calc(0.625rem + 0.4vw);\n}\n\n.form-bttn {\n  align-self: flex-end;\n  padding-right: var(--large-spacing);\n}\n\n/* right side of main content */\n.todo-content {\n  width: calc(100vw - 350px);\n  display: flex;\n  margin: 0px 0px 0px 20px;\n  flex-direction: column;\n}\n\n.todo-tabs {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(100px, 150px));\n  margin-bottom: 10px;\n}\n\n.tabs {\n  color: var(--button-color);\n  background-color: var(--main-color);\n  height: 30px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 10px;\n  box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;\n  margin: 0px 5px 10px 5px;\n}\n\n.tabs:hover {\n  cursor: pointer;\n}\n\n.todo-container-list {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin-top: 10px;\n}\n\n.printObj {\n  height: 100px;\n  font-size: calc(1.025rem + 0.3vw);\n  background-color: var(--main-color);\n  border-radius: 15px;\n  text-align: start;\n  padding: 10px 10px 10px 20px;\n  display: flex;\n}\n\n.box-done {\n  text-decoration: line-through;\n}\n\n.box {\n  margin-left: 20px;\n}\n\n/* footer*/\n.footer {\n  grid-area: footer;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n/* The Modal (background) */\n.modal {\n  display: none; /* Hidden by default */\n  position: fixed; /* Stay in place */\n  z-index: 1; /* Sit on top */\n  padding-top: 100px; /* Location of the box */\n  left: 0;\n  top: 0;\n  width: 100%; /* Full width */\n  height: 100%; /* Full height */\n  overflow: auto; /* Enable scroll if needed */\n  background-color: rgb(0,0,0); /* Fallback color */\n  background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n}\n\n/* Modal Content */\n#open-modal {\n  justify-self: flex-start;\n  margin: 0px 0px 10px 10px;\n}\n\n.modal-content {\n  margin: auto;\n  padding: 0px 10px 0px 10px;\n  border: 1px solid #888;\n  width: max(250px, 25vw);\n  height: max(180px, 18vh);\n  border-radius: 15px;\n  display: grid;\n  grid-template-rows: 30px 1fr;\n  box-shadow: 0 10px 20px -8px rgb(0 0 0 / 70%);\n  background-color: var(--background-color);\n}\n\n.form-modal {\n  font-size: calc(1.025rem + 0.3vw);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  color: var(--button-color);\n  text-align: center;\n  padding: 15px;\n}\n\n.modal-form-bttn {\n  margin-top: 10px;\n  float: center;\n  padding-right: var(--large-spacing);\n}\n\n/* The Close Button */\n.close {\n  color: #aaaaaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: #000;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n\n\n\n\n/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\n\n/* Document\n   ========================================================================== */\n\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in iOS.\n */\n\n html {\n    line-height: 1.15; /* 1 */\n    -webkit-text-size-adjust: 100%; /* 2 */\n  }\n  \n  /* Sections\n     ========================================================================== */\n  \n  /**\n   * Remove the margin in all browsers.\n   */\n  \n  body {\n    margin: 0;\n  }\n  \n  /**\n   * Render the `main` element consistently in IE.\n   */\n  \n  main {\n    display: block;\n  }\n  \n  /**\n   * Correct the font size and margin on `h1` elements within `section` and\n   * `article` contexts in Chrome, Firefox, and Safari.\n   */\n  \n  h1 {\n    font-size: 2em;\n    margin: 0.67em 0;\n  }\n  \n  /* Grouping content\n     ========================================================================== */\n  \n  /**\n   * 1. Add the correct box sizing in Firefox.\n   * 2. Show the overflow in Edge and IE.\n   */\n  \n  hr {\n    box-sizing: content-box; /* 1 */\n    height: 0; /* 1 */\n    overflow: visible; /* 2 */\n  }\n  \n  /**\n   * 1. Correct the inheritance and scaling of font size in all browsers.\n   * 2. Correct the odd `em` font sizing in all browsers.\n   */\n  \n  pre {\n    font-family: monospace, monospace; /* 1 */\n    font-size: 1em; /* 2 */\n  }\n  \n  /* Text-level semantics\n     ========================================================================== */\n  \n  /**\n   * Remove the gray background on active links in IE 10.\n   */\n  \n  a {\n    background-color: transparent;\n  }\n  \n  /**\n   * 1. Remove the bottom border in Chrome 57-\n   * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n   */\n  \n  abbr[title] {\n    border-bottom: none; /* 1 */\n    text-decoration: underline; /* 2 */\n    text-decoration: underline dotted; /* 2 */\n  }\n  \n  /**\n   * Add the correct font weight in Chrome, Edge, and Safari.\n   */\n  \n  b,\n  strong {\n    font-weight: bolder;\n  }\n  \n  /**\n   * 1. Correct the inheritance and scaling of font size in all browsers.\n   * 2. Correct the odd `em` font sizing in all browsers.\n   */\n  \n  code,\n  kbd,\n  samp {\n    font-family: monospace, monospace; /* 1 */\n    font-size: 1em; /* 2 */\n  }\n  \n  /**\n   * Add the correct font size in all browsers.\n   */\n  \n  small {\n    font-size: 80%;\n  }\n  \n  /**\n   * Prevent `sub` and `sup` elements from affecting the line height in\n   * all browsers.\n   */\n  \n  sub,\n  sup {\n    font-size: 75%;\n    line-height: 0;\n    position: relative;\n    vertical-align: baseline;\n  }\n  \n  sub {\n    bottom: -0.25em;\n  }\n  \n  sup {\n    top: -0.5em;\n  }\n  \n  /* Embedded content\n     ========================================================================== */\n  \n  /**\n   * Remove the border on images inside links in IE 10.\n   */\n  \n  img {\n    border-style: none;\n  }\n  \n  /* Forms\n     ========================================================================== */\n  \n  /**\n   * 1. Change the font styles in all browsers.\n   * 2. Remove the margin in Firefox and Safari.\n   */\n  \n  button,\n  input,\n  optgroup,\n  select,\n  textarea {\n    font-family: inherit; /* 1 */\n    font-size: 100%; /* 1 */\n    line-height: 1.15; /* 1 */\n    margin: 0; /* 2 */\n  }\n  \n  /**\n   * Show the overflow in IE.\n   * 1. Show the overflow in Edge.\n   */\n  \n  button,\n  input { /* 1 */\n    overflow: visible;\n  }\n  \n  /**\n   * Remove the inheritance of text transform in Edge, Firefox, and IE.\n   * 1. Remove the inheritance of text transform in Firefox.\n   */\n  \n  button,\n  select { /* 1 */\n    text-transform: none;\n  }\n  \n  /**\n   * Correct the inability to style clickable types in iOS and Safari.\n   */\n  \n  button,\n  [type=\"button\"],\n  [type=\"reset\"],\n  [type=\"submit\"] {\n    -webkit-appearance: button;\n  }\n  \n  /**\n   * Remove the inner border and padding in Firefox.\n   */\n  \n  button::-moz-focus-inner,\n  [type=\"button\"]::-moz-focus-inner,\n  [type=\"reset\"]::-moz-focus-inner,\n  [type=\"submit\"]::-moz-focus-inner {\n    border-style: none;\n    padding: 0;\n  }\n  \n  /**\n   * Restore the focus styles unset by the previous rule.\n   */\n  \n  button:-moz-focusring,\n  [type=\"button\"]:-moz-focusring,\n  [type=\"reset\"]:-moz-focusring,\n  [type=\"submit\"]:-moz-focusring {\n    outline: 1px dotted ButtonText;\n  }\n  \n  /**\n   * Correct the padding in Firefox.\n   */\n  \n  fieldset {\n    padding: 0.35em 0.75em 0.625em;\n  }\n  \n  /**\n   * 1. Correct the text wrapping in Edge and IE.\n   * 2. Correct the color inheritance from `fieldset` elements in IE.\n   * 3. Remove the padding so developers are not caught out when they zero out\n   *    `fieldset` elements in all browsers.\n   */\n  \n  legend {\n    box-sizing: border-box; /* 1 */\n    color: inherit; /* 2 */\n    display: table; /* 1 */\n    max-width: 100%; /* 1 */\n    padding: 0; /* 3 */\n    white-space: normal; /* 1 */\n  }\n  \n  /**\n   * Add the correct vertical alignment in Chrome, Firefox, and Opera.\n   */\n  \n  progress {\n    vertical-align: baseline;\n  }\n  \n  /**\n   * Remove the default vertical scrollbar in IE 10+.\n   */\n  \n  textarea {\n    overflow: auto;\n  }\n  \n  /**\n   * 1. Add the correct box sizing in IE 10.\n   * 2. Remove the padding in IE 10.\n   */\n  \n  [type=\"checkbox\"],\n  [type=\"radio\"] {\n    box-sizing: border-box; /* 1 */\n    padding: 0; /* 2 */\n  }\n  \n  /**\n   * Correct the cursor style of increment and decrement buttons in Chrome.\n   */\n  \n  [type=\"number\"]::-webkit-inner-spin-button,\n  [type=\"number\"]::-webkit-outer-spin-button {\n    height: auto;\n  }\n  \n  /**\n   * 1. Correct the odd appearance in Chrome and Safari.\n   * 2. Correct the outline style in Safari.\n   */\n  \n  [type=\"search\"] {\n    -webkit-appearance: textfield; /* 1 */\n    outline-offset: -2px; /* 2 */\n  }\n  \n  /**\n   * Remove the inner padding in Chrome and Safari on macOS.\n   */\n  \n  [type=\"search\"]::-webkit-search-decoration {\n    -webkit-appearance: none;\n  }\n  \n  /**\n   * 1. Correct the inability to style clickable types in iOS and Safari.\n   * 2. Change font properties to `inherit` in Safari.\n   */\n  \n  ::-webkit-file-upload-button {\n    -webkit-appearance: button; /* 1 */\n    font: inherit; /* 2 */\n  }\n  \n  /* Interactive\n     ========================================================================== */\n  \n  /*\n   * Add the correct display in Edge, IE 10+, and Firefox.\n   */\n  \n  details {\n    display: block;\n  }\n  \n  /*\n   * Add the correct display in all browsers.\n   */\n  \n  summary {\n    display: list-item;\n  }\n  \n  /* Misc\n     ========================================================================== */\n  \n  /**\n   * Add the correct display in IE 10+.\n   */\n  \n  template {\n    display: none;\n  }\n  \n  /**\n   * Add the correct display in IE 10.\n   */\n  \n  [hidden] {\n    display: none;\n  }", "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AAAA,qCAAqC;AACrC,+CAA+C;;AAE/C;;SAES,qBAAqB,CAAC;AAC/B,EAAE,oBAAoB,EAAE,aAAa,EAAE,cAAc,CAAC;AACtD,OAAO,4BAA4B,EAAE,aAAa,EAAE,cAAc,EAAE,SAAS,EAAE,cAAc,CAAC;AAC9F,OAAO,QAAQ,CAAC;AAChB,yBAAyB,QAAQ,EAAE,SAAS,EAAE,QAAQ,CAAC;AACvD,WAAW,QAAQ,EAAE,SAAS,EAAE,eAAe,CAAC;AAChD,uBAAuB,QAAQ,EAAE,iBAAiB,EAAE,mBAAmB,CAAC;AACxE,EAAE,QAAQ,CAAC;AACX,MAAM,iBAAiB,CAAC;AACxB,SAAS,cAAc,EAAE,SAAS,EAAE,QAAQ,CAAC;;AAE7C,YAAY;AACZ;IACI,iCAAiC;AACrC;;AAEA;IACI,iJAAiJ;IACjJ,gBAAgB;IAChB,gBAAgB;IAChB,YAAY;AAChB;;AAEA;IACI,qBAAqB;IACrB,uBAAuB;IACvB,sBAAsB;IACtB,qBAAqB;IACrB,2BAA2B;;IAE3B,qBAAqB;IACrB,sBAAsB;IACtB,oBAAoB;AACxB;;AAEA;EACE,mBAAmB;EACnB,kBAAkB;EAClB,oBAAoB;EACpB,qBAAqB;EACrB,kBAAkB;EAClB,gBAAgB;AAClB;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,UAAU;EACV,YAAY;EACZ,gBAAgB;AAClB;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;EACE,UAAU;EACV,WAAW;AACb;;AAEA;IACI,eAAe;AACnB;;AAEA;EACE,aAAa;EACb,8DAA8D;EAC9D;;;UAGQ;EACR,YAAY;EACZ,4FAA4F;AAC9F;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,uBAAuB;EACvB,aAAa;EACb,4DAA4D;AAC9D;;AAEA,8BAA8B;AAC9B;;AAEA;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,iCAAiC;EACjC,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,0BAA0B;EAC1B,yCAAyC;EACzC,mBAAmB;EACnB,kBAAkB;EAClB,6CAA6C;EAC7C,aAAa;AACf;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;EACnB,iCAAiC;AACnC;;AAEA;EACE,oBAAoB;EACpB,mCAAmC;AACrC;;AAEA,+BAA+B;AAC/B;EACE,0BAA0B;EAC1B,aAAa;EACb,wBAAwB;EACxB,sBAAsB;AACxB;;AAEA;EACE,aAAa;EACb,6DAA6D;EAC7D,mBAAmB;AACrB;;AAEA;EACE,0BAA0B;EAC1B,mCAAmC;EACnC,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB;EACnB,qDAAqD;EACrD,wBAAwB;AAC1B;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,iCAAiC;EACjC,mCAAmC;EACnC,mBAAmB;EACnB,iBAAiB;EACjB,4BAA4B;EAC5B,aAAa;AACf;;AAEA;EACE,6BAA6B;AAC/B;;AAEA;EACE,iBAAiB;AACnB;;AAEA,UAAU;AACV;EACE,iBAAiB;EACjB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA,2BAA2B;AAC3B;EACE,aAAa,EAAE,sBAAsB;EACrC,eAAe,EAAE,kBAAkB;EACnC,UAAU,EAAE,eAAe;EAC3B,kBAAkB,EAAE,wBAAwB;EAC5C,OAAO;EACP,MAAM;EACN,WAAW,EAAE,eAAe;EAC5B,YAAY,EAAE,gBAAgB;EAC9B,cAAc,EAAE,4BAA4B;EAC5C,4BAA4B,EAAE,mBAAmB;EACjD,iCAAiC,EAAE,qBAAqB;AAC1D;;AAEA,kBAAkB;AAClB;EACE,wBAAwB;EACxB,yBAAyB;AAC3B;;AAEA;EACE,YAAY;EACZ,0BAA0B;EAC1B,sBAAsB;EACtB,uBAAuB;EACvB,wBAAwB;EACxB,mBAAmB;EACnB,aAAa;EACb,4BAA4B;EAC5B,6CAA6C;EAC7C,yCAAyC;AAC3C;;AAEA;EACE,iCAAiC;EACjC,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,0BAA0B;EAC1B,kBAAkB;EAClB,aAAa;AACf;;AAEA;EACE,gBAAgB;EAChB,aAAa;EACb,mCAAmC;AACrC;;AAEA,qBAAqB;AACrB;EACE,cAAc;EACd,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;;EAEE,WAAW;EACX,qBAAqB;EACrB,eAAe;AACjB;;;;;;AAMA,2EAA2E;;AAE3E;+EAC+E;;AAE/E;;;EAGE;;CAED;IACG,iBAAiB,EAAE,MAAM;IACzB,8BAA8B,EAAE,MAAM;EACxC;;EAEA;iFAC+E;;EAE/E;;IAEE;;EAEF;IACE,SAAS;EACX;;EAEA;;IAEE;;EAEF;IACE,cAAc;EAChB;;EAEA;;;IAGE;;EAEF;IACE,cAAc;IACd,gBAAgB;EAClB;;EAEA;iFAC+E;;EAE/E;;;IAGE;;EAEF;IACE,uBAAuB,EAAE,MAAM;IAC/B,SAAS,EAAE,MAAM;IACjB,iBAAiB,EAAE,MAAM;EAC3B;;EAEA;;;IAGE;;EAEF;IACE,iCAAiC,EAAE,MAAM;IACzC,cAAc,EAAE,MAAM;EACxB;;EAEA;iFAC+E;;EAE/E;;IAEE;;EAEF;IACE,6BAA6B;EAC/B;;EAEA;;;IAGE;;EAEF;IACE,mBAAmB,EAAE,MAAM;IAC3B,0BAA0B,EAAE,MAAM;IAClC,iCAAiC,EAAE,MAAM;EAC3C;;EAEA;;IAEE;;EAEF;;IAEE,mBAAmB;EACrB;;EAEA;;;IAGE;;EAEF;;;IAGE,iCAAiC,EAAE,MAAM;IACzC,cAAc,EAAE,MAAM;EACxB;;EAEA;;IAEE;;EAEF;IACE,cAAc;EAChB;;EAEA;;;IAGE;;EAEF;;IAEE,cAAc;IACd,cAAc;IACd,kBAAkB;IAClB,wBAAwB;EAC1B;;EAEA;IACE,eAAe;EACjB;;EAEA;IACE,WAAW;EACb;;EAEA;iFAC+E;;EAE/E;;IAEE;;EAEF;IACE,kBAAkB;EACpB;;EAEA;iFAC+E;;EAE/E;;;IAGE;;EAEF;;;;;IAKE,oBAAoB,EAAE,MAAM;IAC5B,eAAe,EAAE,MAAM;IACvB,iBAAiB,EAAE,MAAM;IACzB,SAAS,EAAE,MAAM;EACnB;;EAEA;;;IAGE;;EAEF;UACQ,MAAM;IACZ,iBAAiB;EACnB;;EAEA;;;IAGE;;EAEF;WACS,MAAM;IACb,oBAAoB;EACtB;;EAEA;;IAEE;;EAEF;;;;IAIE,0BAA0B;EAC5B;;EAEA;;IAEE;;EAEF;;;;IAIE,kBAAkB;IAClB,UAAU;EACZ;;EAEA;;IAEE;;EAEF;;;;IAIE,8BAA8B;EAChC;;EAEA;;IAEE;;EAEF;IACE,8BAA8B;EAChC;;EAEA;;;;;IAKE;;EAEF;IACE,sBAAsB,EAAE,MAAM;IAC9B,cAAc,EAAE,MAAM;IACtB,cAAc,EAAE,MAAM;IACtB,eAAe,EAAE,MAAM;IACvB,UAAU,EAAE,MAAM;IAClB,mBAAmB,EAAE,MAAM;EAC7B;;EAEA;;IAEE;;EAEF;IACE,wBAAwB;EAC1B;;EAEA;;IAEE;;EAEF;IACE,cAAc;EAChB;;EAEA;;;IAGE;;EAEF;;IAEE,sBAAsB,EAAE,MAAM;IAC9B,UAAU,EAAE,MAAM;EACpB;;EAEA;;IAEE;;EAEF;;IAEE,YAAY;EACd;;EAEA;;;IAGE;;EAEF;IACE,6BAA6B,EAAE,MAAM;IACrC,oBAAoB,EAAE,MAAM;EAC9B;;EAEA;;IAEE;;EAEF;IACE,wBAAwB;EAC1B;;EAEA;;;IAGE;;EAEF;IACE,0BAA0B,EAAE,MAAM;IAClC,aAAa,EAAE,MAAM;EACvB;;EAEA;iFAC+E;;EAE/E;;IAEE;;EAEF;IACE,cAAc;EAChB;;EAEA;;IAEE;;EAEF;IACE,kBAAkB;EACpB;;EAEA;iFAC+E;;EAE/E;;IAEE;;EAEF;IACE,aAAa;EACf;;EAEA;;IAEE;;EAEF;IACE,aAAa;EACf","sourcesContent":["/****** Elad Shechter's RESET *******/\n/*** box sizing border-box for all elements ***/\n\n*,\n*::before,\n*::after{box-sizing:border-box;}\na{text-decoration:none; color:inherit; cursor:pointer;}\nbutton{background-color:transparent; color:inherit; border-width:0; padding:0; cursor:pointer;}\nfigure{margin:0;}\ninput::-moz-focus-inner {border:0; padding:0; margin:0;}\nul, ol, dd{margin:0; padding:0; list-style:none;}\nh1, h2, h3, h4, h5, h6{margin:0; font-size:inherit; font-weight:inherit;}\np{margin:0;}\ncite {font-style:normal;}\nfieldset{border-width:0; padding:0; margin:0;}\n\n/** Style **/\nhtml { \n    font-size: calc(0.625rem + 0.4vw);\n}\n \nbody {\n    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Fira Sans', 'Droid Sans', 'Helvetica Neue', sans-serif;\n    font-weight: 400;\n    line-height: 1.3;\n    color: white;\n}\n\n:root {\n    --main-color: #ccd0f6;\n    --button-color: #f593b7;\n    --lilac-color: #ad7ffa;\n    --blue-color: #91b2fd;\n    --background-color: #f9fafd;\n\n    --large-spacing: 20px;\n    --medium-spacing: 10px;\n    --small-spacing: 5px;\n}\n\nbutton {\n  font-weight: bolder;\n  text-align: center;\n  transition: all 0.5s;\n  display: inline-block;\n  position: relative;\n  transition: 0.5s;\n}\n\nbutton:after {\n  content: '»';\n  position: absolute;\n  opacity: 0;  \n  right: -20px;\n  transition: 0.5s;\n}\n\nbutton:hover{\n  padding-right: 24px;\n  padding-left:8px;\n}\n\nbutton:hover:after {\n  opacity: 1;\n  right: 10px;\n}\n\nimg {\n    max-width: 100%;\n}\n\n.wrapper {\n  display: grid;\n  grid-template-rows: 80px minmax(calc(100vh - 130px), 1fr) 50px;\n  grid-template-areas: \n  \"header\"\n  \"main-content\"\n  \"footer\";\n  width: 100vw;\n  background-image: linear-gradient(to right, #e65050, var(--lilac-color) , var(--blue-color));\n}\n\n.header {\n  grid-area: header;\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n}\n\n.logo {\n  font-weight: bolder;\n}\n\n.main-content {\n  grid-area: main-content;\n  display: flex;\n  padding: 0px var(--medium-spacing) 0px var(--medium-spacing);\n}\n\n/* left side of main content */\n.form-container {\n  \n}\n\n.form {\n  height: 500px;\n  width: 300px;\n  font-size: calc(1.425rem + 0.1vw);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  color: var(--button-color);\n  background-color: var(--background-color);\n  border-radius: 15px;\n  text-align: center;\n  box-shadow: 0 10px 20px -8px rgba(0, 0, 0,.7);\n  padding: 15px;\n}\n\n.checkbox-container {\n  display: flex;\n  justify-content: space-around;\n  align-items: center;\n  font-size: calc(0.625rem + 0.4vw);\n}\n\n.form-bttn {\n  align-self: flex-end;\n  padding-right: var(--large-spacing);\n}\n\n/* right side of main content */\n.todo-content {\n  width: calc(100vw - 350px);\n  display: flex;\n  margin: 0px 0px 0px 20px;\n  flex-direction: column;\n}\n\n.todo-tabs {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(100px, 150px));\n  margin-bottom: 10px;\n}\n\n.tabs {\n  color: var(--button-color);\n  background-color: var(--main-color);\n  height: 30px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-radius: 10px;\n  box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;\n  margin: 0px 5px 10px 5px;\n}\n\n.tabs:hover {\n  cursor: pointer;\n}\n\n.todo-container-list {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin-top: 10px;\n}\n\n.printObj {\n  height: 100px;\n  font-size: calc(1.025rem + 0.3vw);\n  background-color: var(--main-color);\n  border-radius: 15px;\n  text-align: start;\n  padding: 10px 10px 10px 20px;\n  display: flex;\n}\n\n.box-done {\n  text-decoration: line-through;\n}\n\n.box {\n  margin-left: 20px;\n}\n\n/* footer*/\n.footer {\n  grid-area: footer;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n/* The Modal (background) */\n.modal {\n  display: none; /* Hidden by default */\n  position: fixed; /* Stay in place */\n  z-index: 1; /* Sit on top */\n  padding-top: 100px; /* Location of the box */\n  left: 0;\n  top: 0;\n  width: 100%; /* Full width */\n  height: 100%; /* Full height */\n  overflow: auto; /* Enable scroll if needed */\n  background-color: rgb(0,0,0); /* Fallback color */\n  background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n}\n\n/* Modal Content */\n#open-modal {\n  justify-self: flex-start;\n  margin: 0px 0px 10px 10px;\n}\n\n.modal-content {\n  margin: auto;\n  padding: 0px 10px 0px 10px;\n  border: 1px solid #888;\n  width: max(250px, 25vw);\n  height: max(180px, 18vh);\n  border-radius: 15px;\n  display: grid;\n  grid-template-rows: 30px 1fr;\n  box-shadow: 0 10px 20px -8px rgb(0 0 0 / 70%);\n  background-color: var(--background-color);\n}\n\n.form-modal {\n  font-size: calc(1.025rem + 0.3vw);\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  color: var(--button-color);\n  text-align: center;\n  padding: 15px;\n}\n\n.modal-form-bttn {\n  margin-top: 10px;\n  float: center;\n  padding-right: var(--large-spacing);\n}\n\n/* The Close Button */\n.close {\n  color: #aaaaaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: #000;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n\n\n\n\n/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */\n\n/* Document\n   ========================================================================== */\n\n/**\n * 1. Correct the line height in all browsers.\n * 2. Prevent adjustments of font size after orientation changes in iOS.\n */\n\n html {\n    line-height: 1.15; /* 1 */\n    -webkit-text-size-adjust: 100%; /* 2 */\n  }\n  \n  /* Sections\n     ========================================================================== */\n  \n  /**\n   * Remove the margin in all browsers.\n   */\n  \n  body {\n    margin: 0;\n  }\n  \n  /**\n   * Render the `main` element consistently in IE.\n   */\n  \n  main {\n    display: block;\n  }\n  \n  /**\n   * Correct the font size and margin on `h1` elements within `section` and\n   * `article` contexts in Chrome, Firefox, and Safari.\n   */\n  \n  h1 {\n    font-size: 2em;\n    margin: 0.67em 0;\n  }\n  \n  /* Grouping content\n     ========================================================================== */\n  \n  /**\n   * 1. Add the correct box sizing in Firefox.\n   * 2. Show the overflow in Edge and IE.\n   */\n  \n  hr {\n    box-sizing: content-box; /* 1 */\n    height: 0; /* 1 */\n    overflow: visible; /* 2 */\n  }\n  \n  /**\n   * 1. Correct the inheritance and scaling of font size in all browsers.\n   * 2. Correct the odd `em` font sizing in all browsers.\n   */\n  \n  pre {\n    font-family: monospace, monospace; /* 1 */\n    font-size: 1em; /* 2 */\n  }\n  \n  /* Text-level semantics\n     ========================================================================== */\n  \n  /**\n   * Remove the gray background on active links in IE 10.\n   */\n  \n  a {\n    background-color: transparent;\n  }\n  \n  /**\n   * 1. Remove the bottom border in Chrome 57-\n   * 2. Add the correct text decoration in Chrome, Edge, IE, Opera, and Safari.\n   */\n  \n  abbr[title] {\n    border-bottom: none; /* 1 */\n    text-decoration: underline; /* 2 */\n    text-decoration: underline dotted; /* 2 */\n  }\n  \n  /**\n   * Add the correct font weight in Chrome, Edge, and Safari.\n   */\n  \n  b,\n  strong {\n    font-weight: bolder;\n  }\n  \n  /**\n   * 1. Correct the inheritance and scaling of font size in all browsers.\n   * 2. Correct the odd `em` font sizing in all browsers.\n   */\n  \n  code,\n  kbd,\n  samp {\n    font-family: monospace, monospace; /* 1 */\n    font-size: 1em; /* 2 */\n  }\n  \n  /**\n   * Add the correct font size in all browsers.\n   */\n  \n  small {\n    font-size: 80%;\n  }\n  \n  /**\n   * Prevent `sub` and `sup` elements from affecting the line height in\n   * all browsers.\n   */\n  \n  sub,\n  sup {\n    font-size: 75%;\n    line-height: 0;\n    position: relative;\n    vertical-align: baseline;\n  }\n  \n  sub {\n    bottom: -0.25em;\n  }\n  \n  sup {\n    top: -0.5em;\n  }\n  \n  /* Embedded content\n     ========================================================================== */\n  \n  /**\n   * Remove the border on images inside links in IE 10.\n   */\n  \n  img {\n    border-style: none;\n  }\n  \n  /* Forms\n     ========================================================================== */\n  \n  /**\n   * 1. Change the font styles in all browsers.\n   * 2. Remove the margin in Firefox and Safari.\n   */\n  \n  button,\n  input,\n  optgroup,\n  select,\n  textarea {\n    font-family: inherit; /* 1 */\n    font-size: 100%; /* 1 */\n    line-height: 1.15; /* 1 */\n    margin: 0; /* 2 */\n  }\n  \n  /**\n   * Show the overflow in IE.\n   * 1. Show the overflow in Edge.\n   */\n  \n  button,\n  input { /* 1 */\n    overflow: visible;\n  }\n  \n  /**\n   * Remove the inheritance of text transform in Edge, Firefox, and IE.\n   * 1. Remove the inheritance of text transform in Firefox.\n   */\n  \n  button,\n  select { /* 1 */\n    text-transform: none;\n  }\n  \n  /**\n   * Correct the inability to style clickable types in iOS and Safari.\n   */\n  \n  button,\n  [type=\"button\"],\n  [type=\"reset\"],\n  [type=\"submit\"] {\n    -webkit-appearance: button;\n  }\n  \n  /**\n   * Remove the inner border and padding in Firefox.\n   */\n  \n  button::-moz-focus-inner,\n  [type=\"button\"]::-moz-focus-inner,\n  [type=\"reset\"]::-moz-focus-inner,\n  [type=\"submit\"]::-moz-focus-inner {\n    border-style: none;\n    padding: 0;\n  }\n  \n  /**\n   * Restore the focus styles unset by the previous rule.\n   */\n  \n  button:-moz-focusring,\n  [type=\"button\"]:-moz-focusring,\n  [type=\"reset\"]:-moz-focusring,\n  [type=\"submit\"]:-moz-focusring {\n    outline: 1px dotted ButtonText;\n  }\n  \n  /**\n   * Correct the padding in Firefox.\n   */\n  \n  fieldset {\n    padding: 0.35em 0.75em 0.625em;\n  }\n  \n  /**\n   * 1. Correct the text wrapping in Edge and IE.\n   * 2. Correct the color inheritance from `fieldset` elements in IE.\n   * 3. Remove the padding so developers are not caught out when they zero out\n   *    `fieldset` elements in all browsers.\n   */\n  \n  legend {\n    box-sizing: border-box; /* 1 */\n    color: inherit; /* 2 */\n    display: table; /* 1 */\n    max-width: 100%; /* 1 */\n    padding: 0; /* 3 */\n    white-space: normal; /* 1 */\n  }\n  \n  /**\n   * Add the correct vertical alignment in Chrome, Firefox, and Opera.\n   */\n  \n  progress {\n    vertical-align: baseline;\n  }\n  \n  /**\n   * Remove the default vertical scrollbar in IE 10+.\n   */\n  \n  textarea {\n    overflow: auto;\n  }\n  \n  /**\n   * 1. Add the correct box sizing in IE 10.\n   * 2. Remove the padding in IE 10.\n   */\n  \n  [type=\"checkbox\"],\n  [type=\"radio\"] {\n    box-sizing: border-box; /* 1 */\n    padding: 0; /* 2 */\n  }\n  \n  /**\n   * Correct the cursor style of increment and decrement buttons in Chrome.\n   */\n  \n  [type=\"number\"]::-webkit-inner-spin-button,\n  [type=\"number\"]::-webkit-outer-spin-button {\n    height: auto;\n  }\n  \n  /**\n   * 1. Correct the odd appearance in Chrome and Safari.\n   * 2. Correct the outline style in Safari.\n   */\n  \n  [type=\"search\"] {\n    -webkit-appearance: textfield; /* 1 */\n    outline-offset: -2px; /* 2 */\n  }\n  \n  /**\n   * Remove the inner padding in Chrome and Safari on macOS.\n   */\n  \n  [type=\"search\"]::-webkit-search-decoration {\n    -webkit-appearance: none;\n  }\n  \n  /**\n   * 1. Correct the inability to style clickable types in iOS and Safari.\n   * 2. Change font properties to `inherit` in Safari.\n   */\n  \n  ::-webkit-file-upload-button {\n    -webkit-appearance: button; /* 1 */\n    font: inherit; /* 2 */\n  }\n  \n  /* Interactive\n     ========================================================================== */\n  \n  /*\n   * Add the correct display in Edge, IE 10+, and Firefox.\n   */\n  \n  details {\n    display: block;\n  }\n  \n  /*\n   * Add the correct display in all browsers.\n   */\n  \n  summary {\n    display: list-item;\n  }\n  \n  /* Misc\n     ========================================================================== */\n  \n  /**\n   * Add the correct display in IE 10+.\n   */\n  \n  template {\n    display: none;\n  }\n  \n  /**\n   * Add the correct display in IE 10.\n   */\n  \n  [hidden] {\n    display: none;\n  }"],"sourceRoot":""}]);
// Exports
...
var toDoObject = function toDoObject(title, description, date, priority, project) {
  return {
    title: title,
...
var toDoArray = function () {
  ...
  var projectValue = function projectValue() {
    ...
    for (var i = 0; i < projectObj.projectArray.length; i++) {
      if (projectObj.projectArray[i] === projectObj.projectArray[projectObj.returnCurrent()]) {
        console.log("projected value ".concat(i));
        return i;
      }
    }
  ...
  var add = function add() {
    var newToDo = toDoObject("".concat(title.value), "".concat(description.value), "".concat(date.value), "".concat(document.querySelector('input[name="priority"]:checked').value), "".concat(projectObj.projectArray[projectValue()]));
    addToDo(newToDo);
  ...
  var removeObj = function removeObj(obj) {
    ...
    for (var i = 0; i < container.length; i++) {
      if ("".concat(parent.id) === container[i].title) {
...
var localStorageMod = function () {
  ...
  var getProject = function getProject() {
    ...
    project.forEach(function (obj) {
      return projectObj.newProject(obj);
    });
  };
...
var projectObj = function () {
  ...
  var currentProject = function currentProject(string) {
    if (projectArray.includes(string)) {
      for (var i = 0; i < projectArray.length; i++) {
        if (projectArray[i] === "".concat(string)) {
          current = i;
...
var toDoContainer = function () {
  ...
  var print = function print(obj) {
    console.log("".concat(obj.project, " and ").concat(projectObj.projectArray[projectObj.returnCurrent()]));
    ...
    if (obj.project === projectObj.projectArray[projectObj.returnCurrent()]) {
      ...
      box.innerText = "".concat(obj.title, " | ").concat(obj.date, "\n").concat(obj.description, "\nPriority ").concat(obj.priority);
      containerList.appendChild(_toDoContainer);

      _toDoContainer.appendChild(checkBox);

      _toDoContainer.appendChild(box);
...
var buttonClicker = function buttonClicker(target) {
  var title = document.querySelector('#title');
  var description = document.querySelector('#description');
  var date = document.querySelector('#date');
  var priority = document.querySelector('input[name="priority"]:checked');
  var newProject = document.querySelector('#project').value;
  var modal = document.getElementById('myModal'); // checks if form is empty before running functions to modify DOM

  if ("".concat(target.classList) === 'form-bttn') {
    if (title.value === '' || description.value === '' || date.value === '' || priority.value === false) {
      return;
    }
  ...
  } else if ("".concat(target.classList) === 'modal-form-bttn') {
...
window.addEventListener('load', function (event) {
  ...
  }); // first object tab on Array

  projectObj.currentProject("".concat(projectObj.projectArray[0]));
...
/******/ })()
;
//# sourceMappingURL=bundlef7e82e6023ef4856f01c.js.map